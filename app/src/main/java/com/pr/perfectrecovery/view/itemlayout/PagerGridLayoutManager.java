...
package com.pr.perfectrecovery.view.itemlayout;
...
//        Log("mOffsetX = " + mOffsetX);
//        Log("mOffsetY = " + mOffsetY);
...
//        Log("displayRect = " + displayRect.toString());

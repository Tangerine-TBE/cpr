...
public class BleManager {
    ...
    private static final int DEFAULT_MTU = 30;
    private static final int DEFAULT_MAX_MTU = 512;
    private static final int DEFAULT_WRITE_DATA_SPLIT_COUNT = 26;
    ...
    public BluetoothGatt connect(String mac, BleGattCallback bleGattCallback) {
        ...
        BleDevice bleDevice = new BleDevice(bluetoothDevice, 0, null, 0, 0);
    ...
    public BleDevice convertBleDevice(ScanResult scanResult) {
        ...
        return new BleDevice(bluetoothDevice, rssi, bytes, timestampNanos, 0);
    }
